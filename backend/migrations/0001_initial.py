    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cool_temp_highlimit', models.IntegerField(verbose_name='制冷温控范围最高温')),
                ('cool_temp_lowlimit', models.IntegerField(verbose_name='制冷温控范围最低温')),
                ('heat_temp_highlimit', models.IntegerField(verbose_name='制热温控范围最高温')),
                ('heat_temp_lowlimit', models.IntegerField(verbose_name='制热温控范围最低温')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update', models.TimeField(default=datetime.datetime(2020, 6, 27, 21, 32, 39, 591248), verbose_name='上次更新时间')),
            ],
        ),
        migrations.CreateModel(
            name='Tenant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ntemp', models.IntegerField(verbose_name='当前温度')),
                ('fee_rate', models.FloatField(choices=[(0.01666, '高风单位耗电量(度/秒)'), (0.00833, '高风单位耗电量(度/秒)'), (0.00556, '高风单位耗电量(度/秒)')], default=2, verbose_name='费率')),
                ('fee', models.FloatField()),
                ('RR_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.RequestRecord')),
            ],
        ),
    ]
